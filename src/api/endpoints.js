...
export const UPDATE_FLIGHT_CANCEL = '/cdmOps/cancel';
...
export const UPDATE_RESOURCE_CORELATION = '/master-correlation/resource'
export const AIRLINE_CORELATION = '/master-correlation/airlines'
