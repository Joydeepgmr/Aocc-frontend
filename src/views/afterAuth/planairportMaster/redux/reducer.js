...
export const planAirportMasterSlice = createSlice({
	name: 'planAirportMaster',
	initialState,
	reducers: {
...
export const { addAircraft, formDisabled, updateIsShowTableCompoenents } = planAirportMasterSlice.actions;

export default planAirportMasterSlice.reducer;
